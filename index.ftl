                    ...
                    <div class="item-label">
                        ...
                        <div class="item-meta clearfix">
                            ...
                            <div class="item-meta-ico bg-ico-book"
                                 style="background: url(<?php $this->options->themeUrl('images/bg-ico.png'); ?>) no-repeat;background-size: 40px auto;"></div>
                            ...
                            <div class="item-meta-ico bg-ico-lock"
                                 style="background: url(<?php $this->options->themeUrl('images/bg-ico.png'); ?>) no-repeat;background-size: 40px auto;"></div>
                            <?php else : ?>
                            <div class="item-meta-ico bg-ico-<?php echo randBgIco(); ?>"
                                 style="background: url(<?php $this->options->themeUrl('images/bg-ico.png'); ?>) no-repeat;background-size: 40px auto;"></div>
                            <?php endif; ?>
					...
					<div class="post-onelist-item-container">
						...
						<div class="onelist-item-info">
							...
							<div class="item-readmore">
								<a href="/archives/${post.postUrl!}"> Continue Reading → </a>
							</div>
						</div>
					</div>
				</div>
