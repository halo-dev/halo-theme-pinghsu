        ...
        <#if posts.totalPages gt 1>
            <ol class="page-navigator">
                <#if posts.hasPrevious()>
					<#if posts.number == 1>
                        <li class="prev">
                            <a href="${ctx!}/categories/${category.slugName!}">←</a>
                        </li>
					<#else>
                        <li class="prev">
                            <a href="${ctx!}/categories/${category.slugName!}/page/${posts.number}">←</a>
                        </li>
					</#if>
				</#if>
                <#list rainbow as r>
					<#if r == posts.number+1>
                        <li class="current">
                            <a href="${ctx!}/categories/${category.slugName!}/page/${r}">${r}</a>
                        </li>
					<#else>
                        <li>
                            <a href="${ctx!}/categories/${category.slugName!}/page/${r}">${r}</a>
                ...
                <#if posts.hasNext()>
                    <li class="next">
                        <a href="${ctx!}/categories/${category.slugName!}/page/${posts.number+2}">→</a>
                    </li>
				</#if>
            </ol>
		</#if>
