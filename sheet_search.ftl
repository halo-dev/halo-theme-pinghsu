...
<div class="main-content page-page">
    <div class="search-page">
        <form id="search" class="search-form" method="get" action="${context!}/search" role="search">
        ...
        <@tagTag method="list">
            <#if tags?? && tags?size gt 0>
                <#list tags as tag>
                    <a href="${context!}/tags/${tag.slugName}" class="<#if !settings.post_color!false> bg-white<#else >text-white bg-<@fun.randBgColor/></#if>"># ${tag.name!}(${tag.postCount!0})</a>
                </#list>
            <#else>
            <p> Nothing here ! </p>
            </#if>
